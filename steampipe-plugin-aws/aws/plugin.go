...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"aws_resourcegroups_group":                                     tableAwsResourceGroupsGroup(ctx),
			"aws_opensearchserverless_collection":                          tableAwsOpenSearchServerlessCollection(ctx),
			...
			"aws_backup_region_settings":                                   tableAwsBackupRegionSetting(ctx),
			...
			"aws_ecs_task_set":                                             tableAwsEcsTaskSet(ctx),
			...
			"aws_user_effective_access":                                    tableAwsUserEffectiveAccess(ctx),
			...
			"aws_codestar_project":                                         tableAwsCodeStarProject(ctx),
			"aws_ec2_fleet":                                                tableAwsEc2Fleet(ctx),
			"aws_kafka_cluster":                                            tableAwsKafkaCluster(ctx),
			...
			"aws_neptune_database":                                         tableAwsNeptuneDatabase(ctx),
			"aws_opsworkscm_server":                                        tableAwsOpsWorksCMServer(ctx),
			"aws_organizations_organization":                               tableAwsOrganizationsOrganization(ctx),
			"aws_ses_identity":                                             tableAwsSESIdentity(ctx),
			"aws_shield_protection_group":                                  tableAwsShieldProtectionGroup(ctx),
			"aws_storagegateway_storage_gateway":                           tableAwsStorageGatewayStorageGateway(ctx),
			"aws_workspaces_bundle":                                        tableAwsWorkspacesBundle(ctx),
			"aws_batch_job":                                                tableAwsBatchJob(ctx),
			"aws_batch_compute_environment":                                tableAwsBatchComputeEnvironment(ctx),
			"aws_ses_configuration_set":                                    tableAwsSESConfigurationSet(ctx),
			"aws_batchjob_queue":                                           tableAwsBatchJobQueue(ctx),
			...
			"aws_amp_workspace":                                            tableAwsAMPWorkspace(ctx),
			"aws_appstream_application":                                    tableAwsAppstreamApplication(ctx),
			"aws_appstream_stack":                                          tableAwsAppstreamStack(ctx),
			"aws_cloudfront_origin_access_control":                         tableAwsCloudFrontOriginAccessControl(ctx),
			"aws_cloudfront_streamingdistribution":                         tableAwsCloudFrontStreamingDistribution(ctx),
			"aws_directconnect_connection":                                 tableAwsDirectConnectConnection(ctx),
			"aws_directconnect_gateway":                                    tableAwsDirectConnectGateway(ctx),
			"aws_directory_service_log_subscription":                       tableAwsDirectoryServiceLogSubscription(ctx),
			"aws_dynamodb_global_secondary_index":                          tableAwsDynamodbGlobalSecondaryIndex(ctx),
			"aws_dynamodb_local_secondary_index":                           tableAwsDynamoDbLocalSecondaryIndex(ctx),
			"aws_dynamodbstreams_stream":                                   tableAwsDynamodbstreamsStream(ctx),
			"aws_ec2_capacity_reservation_fleet":                           tableAwsEc2CapacityReservationFleet(ctx),
			"aws_ec2_host":                                                 tableAwsEc2Host(ctx),
			...
			"aws_fsx_snapshot":                                             tableAwsFsxSnapshot(ctx),
			"aws_fsx_storage_virtual_machine":                              tableAwsFsxStorageVirtualMachine(ctx),
			"aws_fsx_task":                                                 tableAwsFsxTask(ctx),
			"aws_fsx_volume":                                               tableAwsFsxVolume(ctx),
			"aws_grafana_workspace":                                        tableAwsGrafanaWorkspace(ctx),
