		...
		Columns: awsKaytuRegionalColumns([]*plugin.Column{
			{
				...
				Transform:   transform.FromField("Description.AddressTransfer.AllocationId")},
			{
				Name:        "address_transfer_status",
				Description: "The Elastic IP address transfer status.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.AddressTransfer.AddressTransferStatus")},
			{
				Name:        "public_ip",
				Description: "The Elastic IP address being transferred.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.AddressTransfer.PublicIp")},
			{
				Name:        "transfer_account_id",
				Description: "The ID of the account that you want to transfer the Elastic IP address to.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.AddressTransfer.TransferAccountId")},
			{
				Name:        "transfer_offer_accepted_timestamp",
				Description: "The timestamp when the Elastic IP address transfer was accepted.",
				Type:        proto.ColumnType_TIMESTAMP,
				Transform:   transform.FromField("Description.AddressTransfer.TransferOfferAcceptedTimestamp")},
			{
				Name:        "transfer_offer_expiration_timestamp",
				Description: "The timestamp when the Elastic IP address transfer expired.",
				Type:        proto.ColumnType_TIMESTAMP,
				Transform:   transform.FromField("Description.AddressTransfer.TransferOfferExpirationTimestamp")},
