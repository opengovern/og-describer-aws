	...
	return &plugin.Table{
		...
		Columns: awsKaytuRegionalColumns([]*plugin.Column{
			...
			{Name: "filter",
				...
				Description: "The cloudwatch filter pattern for the search.",
			},
			...
			{Name: "log_stream_name",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.TrailEvent.LogStreamName"),
				Description: "The name of the log stream to which this event belongs."},

			{Name: "timestamp",
				Type:        proto.ColumnType_TIMESTAMP,
				Transform:   transform.FromField("Description.TrailEvent.Timestamp").Transform(transform.UnixMsToTimestamp),
				Description: "The time when the event occurred."},

			{Name: "timestamp_ms",
				Type:        proto.ColumnType_INT,
				Transform:   transform.FromField("Description.TrailEvent.Timestamp"),
				Description: "The time when the event occurred."},

			// CloudTrail event fields
			{Name: "access_key_id",
				Type:        proto.ColumnType_STRING,
				Hydrate:     getCloudtrailMessageField,
			...
			{Name: "user_identifier",
				Type:    proto.ColumnType_STRING,
				Hydrate: getCloudtrailMessageField,
				Transform: transform.FromField("UserIdentity.Arn",
			...
			{Name: "cloudtrail_event",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Message").Transform(trim).Transform(transform.UnmarshalYAML),
				Description: "The CloudTrail event in the json format."},
